#!/usr/bin/env python3
"""Generate a one-column graphical abstract: pathology, principle, result."""
import matplotlib
matplotlib.use("Agg")
...
# Panel 2: condensed regime principle.
...
ax1.legend(fontsize=8, frameon=False, loc="upper right", handlelength=1.4,
           borderaxespad=0.1)

# Panel 3: bounded result.
...
ax2.set_ylim(0, 44)
ax2.set_title("38.16 AP md100; 58% params;\nsampling adds no inference module",
              fontsize=11.2, fontweight="bold", pad=8)
